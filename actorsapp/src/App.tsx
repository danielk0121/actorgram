...
const SAMPLE_MOVIES: Movie[] = [
  ...
  },
  {
    ...
    actors: [
      ...
      { name: '휴고 위빙', role: '에이전트 스미스', birthYear: 1959, nationality: '호주', debutDate: '1984-01-01' },
      { name: '글로리아 포스터', role: '오라클', birthYear: 1933, nationality: '미국', debutDate: '1964-01-01' },
      { name: '조 팬톨리아노', role: '사이퍼', birthYear: 1951, nationality: '미국', debutDate: '1976-01-01' },
    ],
  },
  {
